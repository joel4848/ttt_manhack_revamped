    ...
    self:HookAddOverride("HUDPaint", "ManhackHUD", function()
                ...
                if className ~= self.ClassName then
                    ...
                    if text and not ent.Alive or (ent.Alive and ent:Alive()) then
                        ...
                        if screenPosition.visible then
                            ...
                            draw.SimpleTextOutlined(text, self.HUDTextFont, screenPosition.x, screenPosition.y - self.HUDTargetYSpacing, self.HUDTextColor, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, self.HudTextOutlineSize, self.HUDTextOutlineColor)
                            draw.SimpleTextOutlined(self.HUDTargetTextHP .. ent:Health(), self.HUDTextFont, screenPosition.x, screenPosition.y + self.HUDTargetYSpacing, self.HUDTextColor, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, self.HudTextOutlineSize, self.HUDTextOutlineColor)
                        end
                    end
                end
            end
        ...
        if ControllableManhack.ConVarHUDTexts() and not self:ThirdPersonEnabled() or (self:ThirdPersonEnabled() and ControllableManhack.ConVarThirdPersonHUD()) then
            ...
            for hudTextIndex, hudText in pairs(self.HUDTexts) do
                ...
                draw.SimpleTextOutlined(hudText.name, self.HUDTextFont, self.HUDTextOffset.x, y, self.HUDTextColor, TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP, self.HudTextOutlineSize, self.HUDTextOutlineColor)
                draw.SimpleTextOutlined(self.HUDTextSeperator, self.HUDTextFont, self.HUDTextOffset.x + self.HUDTextSeperatorXSpacing, y, self.HUDTextColor, TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP, self.HudTextOutlineSize, self.HUDTextOutlineColor)
