...
SWEP.CanBuy = {ROLE_TRAITOR, ROLE_SURVIVALIST, ROLE_DETECTIVE}
...
if( CLIENT ) then
    ...
    SWEP.Icon = "controllable_manhack/Manhack";
 
   SWEP.EquipMenuData = {
      type = "item_weapon",
      desc = "Left click to deploy, Right click to control."
   };
...
if SERVER then
   ...
   resource.AddFile("controllable_manhack/Manhack")
end
